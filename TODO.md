...
38. **IN PROGRESS — Copilot, 2026-09-12.** **`CouncilCrit`.** `lib/cli/council_crit.rb`. Add focused tests for empty diffs, missing deliberation, veto/pass events, truncation, and runner wiring.
