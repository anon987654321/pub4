...
- **Drag-only reorder** (amber outfits, marketplace variants) is closed 2026-09-26.
  The shared vendored Sortable controller now provides visible Move up/Move down
  buttons, ArrowUp/ArrowDown keyboard movement, focus retention, edge disabling,
  and the existing PATCH persistence path; Amber and Marketplace supply both
