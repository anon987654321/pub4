...
│   ├── run_train.sh ......... local / RunPod training
...
│
├── guides/ .................. narrated m4a walkthroughs. STALE — they describe a
│                              17-image dataset that no longer exists and two lanes
│                              (RunPod, local MPS) that are ruled out. Kept, not trusted.
│
├── ragnhild/ ................ a subject
└── johann/ .................. a subject (no photographs yet)
```
...
```
ragnhild/
├── lora* .................... THE ENTRY POINT. Run this, nothing else.
│                              Named after the directory two levels up, which is
│                              confusing on first read: it is a 7-line shell script
│                              that names the subject and hands to _toolkit.
│                              Usage: ./lora --train-colab --steps 1000
├── subject.env .............. WHO. Three lines: SUBJECT, MODEL, TRIGGER.
├── train.yaml ............... HOW. Rank, learning rate, steps, the 12 validation
│                              prompts. Edited by hand; render_config.rb rewrites a
│                              copy of it per machine and never touches this one.
├── dataset/ ................. WHAT IT LEARNS FROM. Images plus one .txt caption each,
│                              same filename stem. This is the whole training input.
├── colab.ipynb .............. GENERATED by run_train_colab.rb. Do not edit —
│                              regenerating overwrites it. Edit the generator.
