...
FLUX_REPO = ENV.fetch("JOHANN_FLUX_MODEL", "black-forest-labs/FLUX.1-dev")
...
def local_flux_path
  path = ENV.fetch("JOHANN_FLUX_MODEL_PATH", "").strip
...
def main
  ...
  warn "fix: or set JOHANN_FLUX_MODEL_PATH to local FLUX.1-dev"
  2
end
