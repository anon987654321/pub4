...
module ApplicationHelper
  ...
  # Was copy-pasted byte-identical in amber's and brgen's own application_helper.rb;
  # hoisted here since it's app-agnostic (only touches ActiveStorage variants).
