...
class CoverageRatchetTest < Minitest::Test
  ...
  FLOORS = {
    ...
    # controllers 14 -> 17 on 2026-08-18: conversation_pins and
    # group_conversations arrived with their tests, and the floor was already
    # one behind before either of them.
    "brgen" => { "controllers" => 17, "models" => 19 },
