...
module Maps
  class PlacesController < BaseController
    ...
    # The one place the list and its JSON twin decide which places match: city,
    # kind filter, then the live search.
    def places_scope
      ...
      apply_live_search(scope, columns: %w[name kind], vertical: "maps")
    end
