...
module Marketplace
  # brgen's marketplace vertical as a mountable engine. Mirrors Shared::Engine — see
  ...
  class Engine < ::Rails::Engine
    ...
    initializer "marketplace.view_paths" do
      ActiveSupport.on_load(:action_controller_base) do
        append_view_path Marketplace::Engine.root.join("app/views")
      end
    end

    initializer "marketplace.assets" do |app|
      %w[app/assets/stylesheets app/javascript].each do |dir|
        p = Marketplace::Engine.root.join(dir).to_s
