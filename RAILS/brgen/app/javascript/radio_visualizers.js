...
if(typeof window!=="undefined"&&window.addEventListener){
  window.addEventListener('deviceorientation',e=>{
    ...
    deviceTilt={x:gx*2.2,y:gy*2.2};
  },{passive:true});
}
const getParallax=(a)=>a?.parallax ? {x:a.parallax.x*0.5+deviceTilt.x,y:a.parallax.y*0.5+deviceTilt.y} : deviceTilt;
