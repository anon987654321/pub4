...
Usage: run_generate.sh [--check | --train | --train-replicate | --generate | --postpro | --all]
  ...
  --train-replicate  Zip dataset, train on Replicate (ostris/flux-dev-lora-trainer),
                     pull weights into weights/ragnhild_v2/
...
Environment:
  ...
  RAGNHILD_REPLICATE_DEST=owner/name   (default: $user/ragnhild-flux)
  RAGNHILD_TRIGGER=ragnhild
  RAGNHILD_REPLICATE_STEPS=1000
  RAGNHILD_REPLICATE_LORA_RANK=16
