      ...
      <% if @<%%= model_singular %>.photos.attached? %>
        ...
        <%= tag.div class: "photos" do %>
          <% @<%%= model_singular %>.photos.each do |photo| %>
            <%= image_tag photo, alt: t(".photo_alt", title: @<%%= model_singular %>.title), loading: "lazy" %>
          <% end %>
        <% end %>
      <% end %>
...
<%= turbo_frame_tag "new_<%%= model_singular %>" do %>
  ...
  <%= tag.article class: "form-container" do %>
    ...
    <%= tag.footer do %>
      ...
      <%= link_to t(".cancel"), <%%= model_plural %>_path, class: "button secondary" %>
...
<%= turbo_frame_tag dom_id(@<%%= model_singular %>) do %>
  ...
  <%= tag.article class: "form-container" do %>
    ...
    <%= tag.footer do %>
      ...
      <%= link_to t(".cancel"), <%%= model_singular %>_path(@<%%= model_singular %>), class: "button secondary" %>
