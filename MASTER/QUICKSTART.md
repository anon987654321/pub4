...
For production friction (relayd, VPS shedding, Rails phantom FKs, seed drift): run `bin/playbook` or read `data/operator_playbook.yml` — lessons are codified from real operator sessions.
