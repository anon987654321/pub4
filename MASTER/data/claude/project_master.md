...
Password changes each session — check DEPLOY/OPERATOR.md for current access pattern.
...
Session Startup: read data/state.yml, data/limits.yml, data/rules.yml, data/voice.yml, data/style.yml, data/models.yml
