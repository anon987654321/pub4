...
module Master
  module Io
    ...
    # MASTER/tools/lora/ragnhild/weights. The film is prunaai/p-video-2-pro. Before
    ...
    class IdeaPicture
      ...
      SUBJECT = File.join(ROOT, "MASTER/tools/lora/ragnhild")
      ...
      def grade(path)
        ...
        script = File.join(ROOT, "MASTER/tools/postpro/postpro.rb")
