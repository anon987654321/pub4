...
module Master
  module Io
    ...
    # STUDIO/lora/ragnhild/weights. The film is prunaai/p-video-2-pro. Before
    ...
    class IdeaPicture
      ...
      SUBJECT = File.join(ROOT, "STUDIO/lora/ragnhild")
      ...
      def grade(path)
        ...
        script = File.join(ROOT, "STUDIO/postpro/postpro.rb")
