...
module Master
  ...
  class IntentRouter
    ...
    RISK_TIERS = {
      low:      %i[codify_policy refactor_to_ruby create_facade apply_user_style_rules run_sound_review run_ui_review],
      medium:   %i[wire_existing_module verify_patch_landed continue_prior_plan prefer_ruby],
