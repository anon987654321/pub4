...
# Executor: Consolidated execution functionality
# Merges Engine (code scanning and analysis) and Shell (command parsing and execution)
# This module contains all functionality previously split across engine.rb and shell.rb
