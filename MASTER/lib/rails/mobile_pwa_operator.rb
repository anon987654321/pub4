...
module Master
  ...
  class MobilePwaOperator
    ...
    def generation_plan(goal)
      ...
      [
        "rails new #{name} --skip-action-mailer --skip-action-mailbox --skip-action-text",
        "bundle add solid_queue solid_cache solid_cable && bin/rails solid_queue:install solid_cache:install solid_cable:install",
