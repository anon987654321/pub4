...
module Master
  module Deploy
    module OperatorDocs
      ...
      OPERATOR_PATH = File.join(ROOT, "DEPLOY", "data", "operator.yml")
      DEBT_PATH = File.join(ROOT, "DEPLOY", "data", "debt.yml")
      ...
      def render_deploy
        data = load_operator
        lines = ["DEPLOY operator (runtime: DEPLOY/data/operator.yml)", ""]
