  ...
  module Voice
    ...
    module VisualRuntime
      MICRO_BUS_MAP = {
        ...
        "mi_064" => { event: "council:deliberation", mode: "start", entropy: 0.45, confidence: 0.58 },
        ...
        "council_deliberation" => { event: "council:deliberation", mode: "start", entropy: 0.45, confidence: 0.58 },
