...
module Master
  ...
  module Reach
    TOOL_MAP = {
      ...
      "WriteFile"       => ->(r, i) { Master::Reach::WriteFile.new(root: r, undo: i[:undo], governor: i[:governor], event_bus: i[:bus], diff_stager: i[:diff_stager]) },
      "StrReplace"      => ->(r, i) { Master::Reach::StrReplace.new(root: r, undo: i[:undo], governor: i[:governor], event_bus: i[:bus], diff_stager: i[:diff_stager]) },
      "BatchReplace"    => ->(r, i) { Master::Reach::BatchReplace.new(root: r, governor: i[:governor], event_bus: i[:bus]) },
      ...
      "SymbolLookup"    => ->(r, i) { Master::Reach::SymbolLookup.new(code_index: i[:code_index], event_bus: i[:bus]) },
      ...
      "Repligen"        => ->(r, i) { Master::Reach::Repligen.new(root: r, governor: i[:governor], event_bus: i[:bus]) },
