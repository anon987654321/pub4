...
require_relative 'paths' # Ensure Paths is loaded before CLI
require_relative 'cli/constants'
require_relative 'cli/ui_helpers'
require_relative 'cli/state_management'
...
module MASTER
  class CLI
    ...
    # File paths (Paths must be loaded via require_relative above)
