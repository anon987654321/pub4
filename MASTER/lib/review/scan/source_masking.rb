...
module Master
  module Review
    module Scan
      ...
      #
      # Every method replaces the region with spaces of the same length rather
      # than deleting it, so line and column numbers in a finding still point at
      # the real source. That invariant is why these belong together and why
      # none of them may start returning a shortened string.
      module SourceMasking
    COMMENT_LINE = %r{^[ \t]*(#|//)[^\n]*}
