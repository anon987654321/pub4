...
void main() {
  ...
  `}const va=class extends Bt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new $i(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}const vp={[ao]:"Linear",[oo]:"Reinhard",[lo]:"Cineon",[co]:"ACESFilmic",[uo]:"AgX",[fo]:"Neutral",[ho]:"Custom"};function yp(i,e){let t=vp[e];return t===void 0?(Te("WebGLProgram: Unsupported toneMapping:",e),`vec3 ${i}( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 ${i}( vec3 color ) { return `+t+"ToneMapping( color ); }"}const _a=new F;function Mp(){Ve.getLuminanceCoefficients(_a);let i=_a.x.toFixed(4),e=_a.y.toFixed(4),t=_a.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`  const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"  return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}const Ip={[es]:"SHADOWMAP_TYPE_PCF",[wi]:"SHADOWMAP_TYPE_VSM"};function Pp(i){return Ip[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Lp={[kn]:"ENVMAP_TYPE_CUBE",[ti]:"ENVMAP_TYPE_CUBE",[ts]:"ENVMAP_TYPE_CUBE_UV"};function Dp(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Lp[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Np={[ti]:"ENVMAP_MODE_REFRACTION"};function Up(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Np[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Fp={[ro]:"ENVMAP_BLENDING_MULTIPLY",[Wl]:"ENVMAP_BLENDING_MIX",[Xl]:"ENVMAP_BLENDING_ADD"};function Op(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Fp[i.combine]||"ENVMAP_BLENDING_NONE"}function Bp(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function zp(i,e,t,n){let s=i.getContext(),r=t.defines,a=t.vertexShader,o=t.fragmentShader,c=Pp(t),l=Dp(t),u=Up(t),p=Op(t),h=Bp(t),m=Sp(t),_=bp(r),M=s.createProgram(),f,d,S=t.glslVersion?"#version "+t.glslVersion+`
