(() => {
  ...
  function frame(now){state.time=now;updatePressure();const t=now*0.00035;ctx.clearRect(0,0,state.w,state.h);ctx.globalCompositeOperation="lighter";drawTerrain(t);drawGraph();drawVectors(t);drawFlows();drawAgents(t);requestAnimationFrame(frame);}
