...
// at load time and wires its own rAF loop from scratch, so flipping it live
// without restarting that whole boot sequence isn't worth the complexity --
// a reload is simple, correct, and rare enough (a deliberate opt-in toggle,
// not a per-turn action) that the cost is negligible.
if (face3dToggleBtn) {
  const FACE3D_KEY = 'master_face3d';
  try {
