...
bundle exec ruby bin/video lora-train --name ragnhild --local \
  ../MASTER/tools/repligen/lora/ragnhild/sources/*

# Replicate
ruby MASTER/tools/repligen.rb lora_chaos \
  MASTER/tools/repligen/lora/ragnhild/train YOUR_USER/ragnhild ragnhild

# Local ai-toolkit
sh MASTER/tools/repligen/lora/ragnhild/config/run_local.sh

# Ragnhild v2 realism workflow
make -C MASTER/tools/repligen/lora/ragnhild v2-prepare
make -C MASTER/tools/repligen/lora/ragnhild v2-local
make -C MASTER/tools/repligen/lora/ragnhild v2-video V2_VERSION=<replicate-version>
make -C MASTER/tools/repligen/lora/ragnhild v2-commercial V2_VERSION=<replicate-version> SECONDS=36
make -C MASTER/tools/repligen/lora/ragnhild v2-infomercial V2_VERSION=<replicate-version> SECONDS=40
```
