...
#   MASTER/tools/lora/<subject>/lora --train-kaggle
set -eu

: "${SUBJECT:?export SUBJECT=<subject> (the directory name under MASTER/tools/lora/)}"
...
SUBJECT_DIR="$WORK_ROOT/MASTER/tools/lora/$SUBJECT"
START_TRAIN=0
...
chmod +x "$WORK_ROOT/MASTER/tools/lora/_toolkit"/*.sh "$SUBJECT_DIR/lora"
