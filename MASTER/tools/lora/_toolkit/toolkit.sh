...
# disk, it was that a fix had to be made twice: moving lora/ to MASTER/tools/lora/ broke
...
# MASTER/tools/lora/, which the next subject would also have written into.
