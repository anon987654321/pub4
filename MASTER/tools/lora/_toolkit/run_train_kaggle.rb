...
#
# The split is the same one the rest of MASTER/tools/lora keeps — Ruby owns the whole
...
def notebook_source(options, dataset_slug)
  <<~PYTHON
    # Generated by MASTER/tools/lora/_toolkit/run_train_kaggle.rb — do not edit here.
