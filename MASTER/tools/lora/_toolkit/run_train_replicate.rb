...
# SUBJECT_DIR points at MASTER/tools/MASTER/tools/lora/<subject>, and subject.env there names
...
# two copies when lora/ moved under MASTER/tools/MASTER/tools/; now there is one.
