...
# SUBJECT_DIR points at MASTER/tools/studio/lora/<subject>, and subject.env there names
...
# two copies when lora/ moved under MASTER/tools/studio/; now there is one.
