...
class FixConvergenceWiringTest < Minitest::Test
  def test_fix_loop_wires_rendered_and_opportunity_evidence
    ...
    assert_includes loop_source, "visual_pass:"
    assert_includes loop_source, "opportunity_pass:"

    assert_includes runner_source, "run_visual_pass"
    assert_includes runner_source, "run_opportunity_pass"
    assert_includes runner_source, "partition_findings"
    assert_includes runner_source, "run_visual_stage"
    assert_includes runner_source, "run_opportunity_stage"
