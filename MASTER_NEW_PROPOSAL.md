...
Slices 0–4 done per `core/ABSORPTION.md`. **Bridge milestone 5:** `TurnPipeline` replaces legacy pipeline boot (`build_runtime`).
Slice 6 still open: trim ai_boot accretion. `lib/` still ~368 files.
