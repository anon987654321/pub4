...
Slices 0–4 done per `core/ABSORPTION.md`. **Bridge milestone 4:** Conditional deliberation — `FoldRisk`, ideation prep,
`critique` verb + council gate on high-risk `done`. Slice 5 still open: delete
unused pipeline boot. `lib/` still ~368 files.
