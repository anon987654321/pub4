...
**For LLMs/agents:** Start with `MASTER/QUICKSTART.md`. It is the designed entry point that provides a usable mental model + explicit LLM ergonomics guidance. Only then consult the deep sources below when you need precision.
