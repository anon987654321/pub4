...
| `MASTER/tools/studio/` | Media tools. **dilla** makes beats, **postpro** grades images, **preprompt**/**lora** generate. | `ruby MASTER/tools/studio/dilla/dilla.rb` |
...
root for weeks because of it. They belong beside `MASTER/tools/studio/dilla/dilla.rb`, which
...
in `MASTER/tools/studio/dilla/dilla.rb`, declared in `MASTER/tools/studio/dilla/data/bed.yml` and played
by `ruby MASTER/tools/studio/dilla/dilla.rb bed` (the operator's call, 2026-09-14).
