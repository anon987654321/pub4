...
module MASTER
  ...
  module CommandRegistry
    ...
    COMMANDS = {
      ...
      context:          { desc: "Context control (depth/history/pin)",  usage: "context [depth|history|pin|unpin|show] [value]", group: :system,
                          handler: ->(args, pipeline:) { MASTER::Commands.manage_context(args); MASTER::Commands::HANDLED } },
