...
module Authentication
  ...
  # AN201 Rails 8 auth baseline (Wave 1 unification): modeled after `rails generate authentication` + platform guest support.
  # Full generator + custom migration still TODO (see brgen for canonical rich version with guest).
