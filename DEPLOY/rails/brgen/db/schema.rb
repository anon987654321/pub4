...
ActiveRecord::Schema[8.1].define(version: 20_260_614_235_959) do
  ...
  create_table 'activity_events', force: :cascade do |t|
    ...
    t.index %w[locality created_at], name: 'index_activity_events_on_locality_and_created_at'
    t.index %w[object_type object_id], name: 'index_activity_events_on_object_type_and_object_id'
    t.index %w[source_vertical created_at], name: 'index_activity_events_on_source_vertical_and_created_at'
  end
  ...
  create_table 'marketplace_deals', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[featured priority], name: 'index_marketplace_deals_on_featured_and_priority'
    t.index ['listing_id'], name: 'index_marketplace_deals_on_listing_id'
    t.index %w[starts_at ends_at], name: 'index_marketplace_deals_on_starts_at_and_ends_at'
  end
  ...
  create_table 'marketplace_listing_favorites', force: :cascade do |t|
    ...
    t.index %w[user_id listing_id], name: 'idx_marketplace_favorites_user_listing', unique: true
  ...
  create_table 'marketplace_stores', force: :cascade do |t|
    ...
    t.index %w[vertical active], name: 'index_marketplace_stores_on_vertical_and_active'
  end
  ...
  create_table 'mentions', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[mentionable_type mentionable_id], name: 'index_mentions_on_mentionable'
  ...
  create_table 'moderation_reports', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.integer 'user_id', null: false
    t.index %w[reportable_type reportable_id], name: 'index_moderation_reports_on_reportable_type_and_reportable_id'
    t.index %w[status created_at], name: 'index_moderation_reports_on_status_and_created_at'
  ...
  create_table 'notifications', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.integer 'user_id', null: false
    t.index %w[source_type source_id], name: 'index_notifications_on_source_type_and_source_id'
  ...
  create_table 'playlist_collaborations', force: :cascade do |t|
    ...
    t.index %w[user_id set_id playlist_id], name: 'idx_playlist_collab_unique', unique: true
  ...
  create_table 'playlist_dilla_sketches', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.integer 'user_id', null: false
    t.index %w[playlist_id created_at], name: 'index_playlist_dilla_sketches_on_playlist_id_and_created_at'
    t.index ['playlist_id'], name: 'index_playlist_dilla_sketches_on_playlist_id'
    t.index %w[set_id created_at], name: 'index_playlist_dilla_sketches_on_set_id_and_created_at'
  ...
  create_table 'playlist_likes', force: :cascade do |t|
    ...
    t.index %w[user_id set_id playlist_id], name: 'idx_playlist_likes_unique', unique: true
  ...
  create_table 'playlist_set_tracks', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.integer 'user_id', null: false
    t.index %w[playlist_set_id playlist_track_id], name: 'idx_on_playlist_set_id_playlist_track_id_60911f71fd',
                                                   unique: true
  ...
  create_table 'push_subscriptions', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.integer 'user_id', null: false
    t.index %w[user_id endpoint], name: 'index_push_subscriptions_on_user_id_and_endpoint', unique: true
  end
  ...
  create_table 'reactions', force: :cascade do |t|
    ...
    t.index %w[reactable_type reactable_id], name: 'index_reactions_on_reactable'
    t.index %w[user_id reactable_type reactable_id post_id kind],
            name: 'idx_reactions_unique_user_target_kind', unique: true
  ...
  create_table 'takeaway_delivery_drivers', force: :cascade do |t|
    ...
    t.index %w[available current_lat current_lng], name: 'idx_takeaway_drivers_available_location'
  ...
  create_table 'takeaway_favorite_restaurants', force: :cascade do |t|
    ...
    t.index %w[user_id restaurant_id], name: 'idx_takeaway_favorites_user_restaurant', unique: true
  ...
  create_table 'takeaway_orders', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.integer 'user_id', null: false
    t.index %w[delivery_driver_id status], name: 'index_takeaway_orders_on_delivery_driver_id_and_status'
  ...
  create_table 'takeaway_reviews', force: :cascade do |t|
    ...
    t.index %w[restaurant_id created_at], name: 'index_takeaway_reviews_on_restaurant_id_and_created_at'
  ...
  create_table 'tv_live_streams', force: :cascade do |t|
    ...
    t.index %w[status updated_at], name: 'index_tv_live_streams_on_status_and_updated_at'
  ...
  create_table 'tv_stream_chats', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.integer 'user_id', null: false
    t.index %w[live_stream_id created_at], name: 'index_tv_stream_chats_on_live_stream_id_and_created_at'
  ...
  create_table 'tv_video_notes', force: :cascade do |t|
    ...
    t.index %w[video_id timestamp created_at],
            name: 'index_tv_video_notes_on_video_id_and_timestamp_and_created_at'
